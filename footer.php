    ...
    <div class="max-w-[1200px] mx-auto px-6">
        <div class="grid md:grid-cols-4 gap-12 mb-20">
            <div class="col-span-1 md:col-span-1">
                ...
                <?php
                $footer_affiliation_logo = get_theme_mod('footer_affiliation_logo');
                if ($footer_affiliation_logo) :
                    $footer_affiliation_name = get_theme_mod('footer_affiliation_name', 'Sport Union');
                    $footer_affiliation_url = get_theme_mod('footer_affiliation_url');
                    $affiliation_logo_html = '<img src="' . esc_url($footer_affiliation_logo) . '" alt="' . esc_attr($footer_affiliation_name) . '" class="footer-affiliation-logo">';
                ?>
                <div class="footer-affiliation-badge mb-6">
                    <?php if ($footer_affiliation_url) : ?>
                        <a href="<?php echo esc_url($footer_affiliation_url); ?>" target="_blank" rel="noopener noreferrer" title="Visit <?php echo esc_attr($footer_affiliation_name); ?>">
                            <?php echo $affiliation_logo_html; ?>
                        </a>
                    <?php else : ?>
                        <?php echo $affiliation_logo_html; ?>
                    <?php endif; ?>
