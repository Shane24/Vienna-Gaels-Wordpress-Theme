            ...
            <div class="grid lg:grid-cols-12 gap-12 items-center">
                <div class="lg:col-span-6 z-10">
                    ...
                    <h1 class="text-5xl lg:text-7xl font-black leading-[1.05] tracking-tight mb-8">
                        Experience the Heart of Ireland <span class="text-primary italic">in Vienna.</span>
                    </h1>
                    <p class="text-lg text-slate-600 dark:text-slate-400 max-w-lg mb-10 leading-relaxed">
                        Join Austria's premier Gaelic Games club. Whether you're a seasoned player or a complete beginner, there's a place for you in our community.
                    </p>
                    <div class="flex flex-wrap gap-4">
                        <button class="bg-primary text-white px-8 py-4 rounded-xl font-bold text-lg hover:scale-105 transition-transform">
                            Start Your Journey
                        </button>
                        <button class="border-2 border-primary text-primary px-8 py-4 rounded-xl font-bold text-lg hover:bg-primary/5 transition-colors">
                            View Teams
                        </button>
                    </div>
                </div>
    ...
    <section class="py-20 bg-background-light dark:bg-background-dark celtic-pattern">
        <div class="max-w-[1200px] mx-auto px-6">
            ...
            <div class="flex overflow-x-auto gap-6 pb-8 snap-x no-scrollbar">
                ...
                ?>
                <div class="min-w-[300px] bg-white dark:bg-neutral-800 rounded-2xl p-6 soft-lift snap-center border-l-4 <?php echo $border_color; ?>">
...
<section class="py-20 bg-neutral-50 dark:bg-neutral-900">
    <div class="max-w-[1200px] mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            ?>
            <div class="group relative overflow-hidden rounded-2xl bg-white dark:bg-neutral-800 soft-lift hover:-translate-y-2 transition-all duration-300">
                <div class="aspect-[3/4] bg-cover bg-center grayscale group-hover:grayscale-0 transition-all duration-500" style="background-image: url('<?php echo esc_url($img_url); ?>');"></div>
                <div class="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent"></div>
                <div class="absolute bottom-0 left-0 p-6">
                    <h3 class="text-white text-xl font-bold mb-2"><?php echo esc_html($team['title']); ?></h3>
                    <a href="<?php echo esc_url($page_url); ?>" class="text-primary text-sm font-bold opacity-0 group-hover:opacity-100 transition-opacity">
                        Learn More →
                    </a>
                </div>
            </div>
